 ...
 */
  ...
  $stmt = $pdo->prepare("INSERT INTO data_karyawan (created,uid,nama,no_hp,alamat,picture,jenis_kelamin,id_jabatan,id_admin) VALUES (?,?,?,?,?,?,?,?,?)");

  if ($stmt->execute([$created, $uid, $nama, $no_hp, $alamat, $picture, $jenis_kelamin, $jabatan, $id_admin])) {
    $stmt = null;
