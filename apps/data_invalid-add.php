 ...
 */
  ...
  $stmt = $pdo->prepare("INSERT INTO data_karyawan (created,uid,nama,id_jabatan,no_hp,alamat,picture,jenis_kelamin,id_admin) VALUES (?,?,?,?,?,?,?,?,?)");

  if ($stmt->execute([$created, $uid, $nama, $jabatan, $no_hp, $alamat, $picture, $jenis_kelamin, $id_admin])) {
    $stmt = null;
  } else {
...
<head>
  ...
  <title>Absen Digital - Dashboard</title>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="no_hp" class="form-control" value="<?php echo $no_hp; ?>" placeholder="Input Nomor Hp Karyawan" required>
