...
if (isset($_POST["id"]) && !empty($_POST["id"])) {
  ...
  $stmt = $pdo->prepare("UPDATE data_karyawan SET created=?,uid=?,nama=?,id_jabatan=?,no_hp=?,alamat=?,picture=?,jenis_kelamin=?,id_admin=? WHERE id=?");


  if (!$stmt->execute([$created, $uid, $nama, $jabatan, $no_hp, $alamat, $picture, $jenis_kelamin, $id_admin, $id])) {
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="no_hp" class="form-control" value="<?php echo $no_hp; ?>" placeholder="Input Nomer Hp Karyawan" required>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <select class="form-control" name="jabatan">
                        ...
                        while ($data = mysqli_fetch_assoc($list_jabatan)) {
                          echo '<option value="' . $data['id'] . '" ' . ($jabatan == $data['id'] ? 'selected' : '') . '>' . $data['jabatan'] . '</option>';
                        }
                        ?>
                      </select>
